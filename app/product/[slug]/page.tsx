...
export default async function ProductPage({
  ...
  return (
    <>
      <div className="bg-[#f8f8ff] shadow-carousel py-10">
          ...
          <div className="grid xl:gap-8 grid-rows-[2] grid-cols-1 xl:grid-cols-5">
            ...
            <div className="col-span-2 relative">
              ...
              <div className="grid grid-cols-2 mb-4 border-b border-slate-400 py-2">
                ...
                <span className="text-sm sm:text-md font-normal p-3">
                  <strong className="text-md sm:text-lg">Quilometragem</strong>
                  <p>{data.km}</p>
                </span>
                <span className="text-sm sm:text-md font-normal p-3">
                  <strong className="text-md sm:text-lg">Tipo de Combustível</strong>
              ...
              <div className="mb-4 w-full border-b border-slate-400 pb-2 pl-2">
