  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex flex-col">
        <div className="flex justify-between flex-col sm:flex-row gap-x-12">
          ...
          <div className="flex flex-col-reverse justify-between lg:justify-end items-center  md:items-start h-full w-auto gap-y-10">
            <div className="mr-0 xl:mr-16 h-full">
              ...
              <p className="text-sm 2xl:text-md text-zinc-400 whitespace-nowrap">
            ...
            <div className="flex flex-col justify-start items-start h-full">
              <p className="text-base 2xl:text-xl text-zinc-300 mb-3 w-full text-center">
                Redes Sociais
              </p>
              <a
              ...
              >
                <svg
                  ...
                  className="social-icon mr-2 bg-zinc-700/40 p-3 rounded-lg duration-300 scale-75 2xl:scale-100"
                >
                ...
                <p className="text-base 2xl:text-lg text-zinc-400 text-center">
                  @autosalesbrasil
                </p>
              </a>
              ...
              >
                <svg
                  ...
                  version="1.1"
                  xmlns="http://www.w3.org/2000/svg"
                  className="phone-icon mr-2 bg-zinc-700/40 p-3 rounded-lg duration-300 scale-75 2xl:scale-100"
                >
        ...
        <div className="text-zinc-400 border-t border-zinc-600 py-8 mt-10 md:mt-20 w-full flex flex-col md:flex-row gap-y-6 md:gap-y-0 justify-center items-center gap-x-6">
          <Image
            src="/logo.png"
            alt="logo"
            width={120}
            height={120}
            className="w-20 2xl:w-24 rounded-full shadow-logoFooter font-krona"
          />
          <div className="flex flex-col items-center">
            <span className="name font-semibold text-lg 2xl:text-2xl text-zinc-200">
              Auto Sales Brasil
            </span>
        ...
        <div className="text-xs 2xl:text-sm text-zinc-300 border-t border-zinc-600 pt-8 pb-12 ">
