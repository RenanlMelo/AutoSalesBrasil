  ...
  return (
    <>
      <div className="w-full shadow-about">
        ...
        <div className="py-32 px-32 pb-24 shadow-[0_10px_30px_0_rgba(0,0,0,.6)] relative gap-y-24 flex flex-col">
          ...
          <div className="flex justify-evenly items-center gap-y-4 rounded-xl bg-[#101010] w-full shadow-[10px_0_30px_0_rgba(250,250,250,1))]">
            <div //1º Serviço
              className="shadow-[0_20px_20px_-10px_rgba(0,0,0,.6)] hover:shadow-[0_30px_30px_-10px_rgba(0,0,0,.6)] cursor-pointer rounded-2xl overflow-hidden text-zinc-300 z-10 py-6 w-full xl:w-1/4 lg:text-xl 2xl:text-2xl font-bold flex flex-col items-center justify-center gap-x-10 bg-zinc-900 hover:bg-[#222228] duration-200"
              onClick={openInfo}
            >
      ...
      <div className="w-full">
        <div className="py-32 px-12 mx-32 border-b border-[#8e8e8e50] max-w-4xl">
        ...
        <div className="py-32 px-12 mx-32 border-b border-[#8e8e8e50] max-w-4xl">
          ...
          <ul className="text-lg text-[#8e8e8e] flex gap-y-2 flex-col">
            ...
            <li className="my-2 px-2 text-xl text-[#8e8e8e] border-b border-[#8e8e8e] w-fit">
              Entre em contato pelo botão{" "}
              <strong className="font-bold">abaixo</strong> para podermos lhe
              ajudar.
            </li>
          </ul>
          <div className="w-11/12 h-px mx-auto" />
