      ...
      <div className="w-full">
        <section className="mx-auto max-w-8xl mb-32">
          ...
          <div className="flex justify-center items-center sm:items-stretch flex-col lg:flex-row px-0 xl:px-32 2xl:px-60">
            <div className="w-full lg:bg-transparent lg:w-1/2 flex justify-center lg:justify-end ">
              <Image
                src="/logo3.png"
                alt="logo"
                width={1000}
            ...
            <div className="w-full flex flex-col justify-center items-start border-r shadow-about border-zinc-700">
              <p className="text-[#d8d8dd] text-lg font-light m-12 pb-6 mb-0 indent-10 leading-7 text-justify">
                A{" "}
                <span className="font-semibold text-[#c8c8cc]">
                  Auto Sales Brasil
                </span>{" "}
              ...
              <p className="text-[#d8d8dd] text-lg font-light mx-12 pb-6 indent-10 leading-7 text-justify">
              ...
              <p className="text-[#d8d8dd] text-lg font-light px-12 pt-4 mb-8 leading-7 text-center mx-auto">
                Entre em
                <span> </span>
                <a
                  href="#footer"
