...
export default function Footer() {
  ...
  return (
    <footer
      id="footer"
      className="bg-[#090114] w-full flex flex-col-reverse lg:flex-row justify-between items-center bg-center px-28 pt-32 relative"
    >
      <img
        src="arrow.svg"
        className="bg-zinc-600 rounded-full p-2 w-20 absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-180 hover:bg-zinc-700/80 scale-[85%] hover:scale-100 duration-200"
      ...
      <div className="w-full h-full flex flex-col">
        <div className="flex justify-between">
          <div>
            ...
            <div className="flex flex-col items-center justify-center h-full lg:max-w-sm">
              <p className="text-slate-200 mt-16 lg:mt-0  text-justify font-light mb-3">
              ...
              <input
                type="button"
                className="bg-indigo-900 w-full text-slate-300 text-lg font-semibold p-2 rounded-lg scale-100 hover:scale-105 hover:bg-indigo-950 duration-200"
                value="Enviar"
              />
            </div>
          </div>

          <div className="flex flex-row lg:flex-col-reverse justify-between lg:justify-end  items-start h-full w-full lg:w-auto gap-y-10">
            <div className="mr-0 xl:mr-16 h-full">
              <p className="text-xl text-slate-200 mb-2 text-center">
                Horário de atendimento
              </p>
              <p className="text-md text-zinc-400 whitespace-nowrap">
            ...
            <div className="flex flex-col justify-center items-start xl:items-center h-full">
              <p className="text-xl text-slate-200 mb-3">Redes Sociais</p>
              <a
              ...
              >
                <svg
                  ...
                  className="social-icon mr-2 bg-zinc-700/40 p-3 rounded-lg duration-300"
                >
              ...
              >
                <svg
                  ...
                  version="1.1"
                  xmlns="http://www.w3.org/2000/svg"
                  className="phone-icon mr-2 hover:fill-[#25D366] hover:bg-zinc-700/60 bg-zinc-700/40 p-3 rounded-lg duration-300"
                >
        ...
        <div className="text-2xl text-zinc-200 border-t border-zinc-600 py-8 mt-20 w-full flex justify-center items-center gap-x-6">
          <img src="logo.png" className="w-24 rounded-full shadow-logoFooter" />
          Auto Sales Brasil
        </div>
        <div className="text-sm text-zinc-300 border-t border-zinc-600 pt-8 pb-12 ">
